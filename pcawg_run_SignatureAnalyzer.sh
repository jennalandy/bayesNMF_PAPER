...
filename="/gplab/jlandy/bayesNMF_PAPER/Paper2/pcawg_counts_matrices_nonhyper/${name}.csv"
output_dir="/gplab/jlandy/bayesNMF_PAPER/Paper2/output/pcawg_SignatureAnalyzer/${name}/"
mkdir -p "$output_dir"
