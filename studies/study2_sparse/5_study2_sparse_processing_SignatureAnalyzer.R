...
results3 <- do.call(rbind, list(
    read.csv(file.path(output_dir, "signatureanalyzer_L2_runtime.csv")),
    read.csv(file.path(output_dir, "signatureanalyzer_L2_runtime_2.csv")),
    read.csv(file.path(output_dir, "signatureanalyzer_L2_runtime_3.csv")),
    read.csv(file.path(output_dir, "signatureanalyzer_L2_runtime_4.csv"))
  )) %>% 
  mutate(
