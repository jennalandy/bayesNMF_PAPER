...
ggsave(file.path(figures_dir, "prop_hypermutated.png"))
```
...
data.frame(
  ...
  xlim(c(0, 400))
ggsave(file.path(figures_dir, "n_hypermutated.png"))
```
...
mutation_counts_by_histology %>%
  ...
  ggsave(file.path(figures_dir, "mut_counts_hypermutated.png"))
```
...
ggsave(file.path(figures_dir, "mut_counts_hypermutated_with_n.png"))
```