...
output_dir <- "../../output/study2_N40"
processed_dir <- "../../processed/study2_N40"
figures_dir <- "../../figures/study2_N40"
...
for(model_dir in model_dirs) {
  ...
  for(dir in results_dirs) {
    ...
    write.csv(results, file.path(processed_dir, "metrics.csv"), row.names = FALSE)
  }
}
...
write.csv(results2, file.path(processed_dir, "metrics.csv"), row.names = FALSE)
