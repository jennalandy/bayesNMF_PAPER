---
title: "Analyzing bayesNMF results on study 2 data with a maximum of N = 40 signatures"
author: "Jenna Landy"
---
...
rank_metrics_aligned = results %>%
  ...
  ggtitle("A. Learning rank in 1-40")
  ggh4x::facetted_pos_scales(
    y = list(NULL, scale_y_continuous(limits = c(0, 1.05)), scale_y_continuous(limits = c(0, 1.05)), scale_y_continuous(trans = "log2"))
  )
saveRDS(rank_metrics_aligned, file.path(figures_dir, "N40_rank_metrics_aligned.rds"))
ggsave(file.path(figures_dir, "N40_rank_metrics_aligned.png"), rank_metrics_aligned, width = 7, height = 7)
```
